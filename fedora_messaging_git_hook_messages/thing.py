...
from .base import SCHEMA_URL, FedoraMessagingGitHookMessage, THING_SCHEMA


class NewThingV1(FedoraMessagingGitHookMessage):
    """
    A sub-class of a Fedora message that defines a message schema for messages
    published by Fedora Messaging Git Hook when a new thing is created.
    """

    topic = "fedora-messaging-git-hook.new"
